...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tina84y.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tina84y.containers.anotherwebservice.com/
...
```
git clone git@github.com:SmartArt09/container-tina84y.git
cd container-tina84y
```
...
```
docker attach container-tina84y
```
